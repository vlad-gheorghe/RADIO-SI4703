...
void DisplayServiceName(char *name)
{
  ...
  tft.setCursor(0, 100); tft.setTextColor(ST77XX_GREEN,ST77XX_BLACK);tft.setTextSize(1);
  tft.print(name);
  while (len < 8) {
    tft.print(' ');
    len++;  
 ...
 // int tp=0;
  // tft.setFont(&FreeSerif9pt7b);
   tft.setCursor(2, 110); 
    ...
    tft.print(t,1);
    tft.setCursor(60, 110);tft.print("C");
    //tft.setTextColor(ST77XX_WHITE,ST77XX_BLACK);
    tft.setCursor(49, 100);tft.print(".");
  //  tft.drawCircle(82,110,1,ST77XX_WHITE);
     tft.setCursor(85, 110);tft.setTextColor(ST77XX_WHITE,ST77XX_BLACK);
     tft.print(h);
     tft.setCursor(115, 110);tft.print("%");
    tft.setFont();
}
...
digitalWrite (vd, HIGH);
 ...
 tft.initR(INITR_144GREENTAB); tft.setRotation(3);  
  ...
  tft.setCursor(5, 50);tft.setTextSize(1);
  tft.print("TFT-KeypadRadio");
  tft.setCursor(5, 70);tft.setTextSize(1);
  tft.print("@2019 Vlad Gheorghe");
  delay(3000);
 tft.fillScreen(ST77XX_BLACK);
